...
<div>
    ...
    <x-ui-sidebar-list label="Verwaltung">
        ...
        <x-ui-sidebar-item :href="route('location.standorte.index')">
            @svg('heroicon-o-globe-alt', 'w-4 h-4 text-[var(--ui-secondary)]')
            <span class="ml-2 text-sm">Standorte</span>
        </x-ui-sidebar-item>
    </x-ui-sidebar-list>
    ...
    <div x-show="collapsed" class="px-2 py-2 border-b border-[var(--ui-border)]">
        <div class="flex flex-col gap-2">
            ...
            <a href="{{ route('location.standorte.index') }}" wire:navigate class="flex items-center justify-center p-2 rounded-md text-[var(--ui-secondary)] hover:bg-[var(--ui-muted-5)]">
