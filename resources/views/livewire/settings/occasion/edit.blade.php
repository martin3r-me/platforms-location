<x-ui-page>
    <x-slot name="navbar">
        <x-ui-page-navbar title="Edit Occasion" icon="heroicon-o-calendar-days" />
    </x-slot>
        ...
        <div class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h1 class="text-2xl font-bold text-[var(--ui-secondary)]">Edit Occasion</h1>
                </div>
            </div>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="p-3 bg-[var(--ui-muted-5)] rounded-lg border border-[var(--ui-border)]/40">
                            <div class="text-xs text-[var(--ui-muted)]">Created</div>
                            <div class="text-sm font-medium text-[var(--ui-secondary)]">{{ $occasion->created_at->format('d.m.Y H:i') }}</div>
                        </div>
                        <div class="p-3 bg-[var(--ui-muted-5)] rounded-lg border border-[var(--ui-border)]/40">
                            <div class="text-xs text-[var(--ui-muted)]">Last updated</div>
                            <div class="text-sm font-medium text-[var(--ui-secondary)]">{{ $occasion->updated_at->format('d.m.Y H:i') }}</div>
                        </div>
                    </div>
                </div>
            </div>
